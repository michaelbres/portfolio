...
// NFL/CFB: estimates based on published key-number frequencies (3 ≈ 15%, 7 ≈ 9.5%).
// NBA: computed from 5,829 regular-season games (2019-20 through 2023-24) via nba_api.
...
const MARGIN_DIST = {
  ...
  // NBA: empirical from 5,829 regular-season games (2019-20 through 2023-24) via nba_api
  NBA: {
